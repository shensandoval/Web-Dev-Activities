...
<body>
    ...
    if (isset($_REQUEST['fname'])) {
        ...
        $update = "UPDATE `registration` set firstname='".$firstname."',
        lastname='".$lastname."', emailAdd='".$email."',
        password='".$password."' where id='".$id."'";

        $result = mysqli_query($conn, $update) or die ("Connect failed:\n".mysqli_error($conn));
        if ($result) {
            echo "<div class = 'form'>";
    ...
    <div class="centered_text">
        ...
        <div class="form">
            <form action="" method="post">
                ...
                <button type="submit" name="submit" id="reg_btn"> <i class="fa fa-pencil-square-o" style="color:red"></i>Update </button>
