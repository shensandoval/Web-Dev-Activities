...
<head>
  <title>Hiking Sanctuary | Best trail </title>
  <link rel="icon" href="home_images\icon.jpg">
    ...
    <div class="centered_text">
      ...
      <div class="form">
        <form action="formHandler.php" method="post">
          ...
          <span class="error"> <?php echo (isset($_POST["fname"]))? $_POST["fname"]:""; ?></span> <br>

          <i class="fa fa-user-circle"></i> Last name:
          <input type="text" name="lname">
          <span class="error"> <?php echo (isset($_POST["lname"]))? $_POST["lname"]:""; ?></span> <br>

          <i class="fa fa-envelope-o"></i> Email Address:
          <input type="email" name="em_add">
          <span class="error"> <?php echo (isset($_POST["email"]))? $_POST["email"]:""; ?></span> <br>

          <i class="fa fa-address-book"></i> Address:
          <input type="text" name="add">
          <span class="error"> <?php echo (isset($_POST["add"]))? $_POST["add"]:""; ?></span> <br>


          <button type="submit" name="submit" id="reg_btn"> <i class="fa fa-pencil-square-o" style="color:red"></i> Register </button>

          <p>Already have account? <a href="login.php"> Login here</p>
